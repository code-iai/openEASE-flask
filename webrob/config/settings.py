...
SQLALCHEMY_DATABASE_URI = 'postgresql://docker@localhost:5432/docker'   # currentl only for testing
...
MAIL_PASSWORD = evg.get_variable_with_default('OPENEASE_MAIL_PASSWORD', '12345678') # possibly remove default returns, https://github.com/code-iai/openEASE-flask/issues/4
...
TWITTER_APP_TOKENS  = (evg.get_variable_with_default_none('TWITTER_APP_ID'), evg.get_variable_with_default_none('TWITTER_APP_SECRET'))
GITHUB_APP_TOKENS   = (evg.get_variable_with_default_none('GITHUB_APP_ID'), evg.get_variable_with_default_none('GITHUB_APP_SECRET'))
GOOGLE_APP_TOKENS   = (evg.get_variable_with_default_none('GOOGLE_APP_ID'), evg.get_variable_with_default_none('GOOGLE_APP_SECRET'))
