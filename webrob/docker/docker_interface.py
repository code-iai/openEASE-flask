...
client = pyjsonrpc.HttpClient(url="http://" +
                                  evg.get_variable_with_default('DOCKERBRIDGE_PORT_5001_TCP_ADDR', 'dockerbrige_port_tcp_address') +
                                  ':' + evg.get_variable_with_default('DOCKERBRIDGE_PORT_5001_TCP_PORT', 'dockerbrige_port_tcp_port'))
